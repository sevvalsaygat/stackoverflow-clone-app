...
type SvgQuestionType = {
  className?: string;
};

const SvgQuestion = ({ className }: SvgQuestionType) => {
  return (
    <svg width="26" height="26" className={className}>
      <path opacity=".5" d="M4.2 4H22a2 2 0 012 2v11.8a3 3 0 002-2.8V5a3 3 0 00-3-3H7a3 3 0 00-2.8 2z" fill="currentColor"></path>
      <path
