...
type SvgSpotPencilType = {
  className?: string;
};

/* eslint-disable max-len */
const SvgSpotPencil = ({ className }: SvgSpotPencilType) => {
  return (
    <svg aria-hidden="true" className={className} width="48" height="48" viewBox="0 0 48 48">
      <path
