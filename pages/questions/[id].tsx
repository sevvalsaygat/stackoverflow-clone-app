                      ...
                      <div className="w-full">
                        ...
                        <div className="relative">
                          <a className="flex flex-row align-center items-center bg-gray-150 border-r-3 border-orange-400 py-6 pl-8 pb-4 cursor-pointer">
                              ...
                              <Link href="/all_questions" className="text-13 font-700 text-neutral-900 leading-17 w-full cursor-pointer">
                                  Questions
                              </Link>
                          </a>
                        </div>
                            ...
                            <div className='pr-16'>
                              ...
                              <div className='mt-24 mb-12'>
                                <div className='flex flex-row'>
                                  <div className='border border-transparent bg-cyan-50 hover:bg-cyan-450 text-sky-300 p-6 text-12 rounded-3 leading-12 mr-5 hover:text-blue-350 cursor-pointer'>{data.tag}</div>
                                </div>
                              </div>
                                  ...
                                  <div className='px-6 py-7'>
                                    ...
                                    <div className='flex flex-row'>
                                      ...
                                      <div className='ml-8 flex flex-col'>
                                          <div className='text-13 leading-17 text-blue-700 hover:text-sky-600 cursor-pointer'>{data.owner.name}</div>
                                          ...
                                          <div key={index} className='flex flex-col'>
                                            ...
                                            <div className='m-4 flex flex-row justify-between'>
                                              ...
                                              <div className='flex flex-col m-4 border-transparent rounded-3 w-200 pr-16'>
                                                <div className='px-6 py-7'>
                                                  <div className='mb-4 text-12 leading-15 text-gray-250'>answered just now</div>
                                                    <div className='flex flex-row'>
                                                      <div>
                                                          <Icons.SvgUser className='border rounded-3 p-2 w-9 h-9' />
                                                      </div>
                                                      <div className='ml-8 flex flex-col'>
                                                        <div className='text-13 leading-17 text-blue-700 hover:text-sky-600 cursor-pointer'>{answer.user.name}</div>
                                                        <div className='text-12 leading-17 text-gray-250'>1</div>
                                                      </div>
                                                    </div>
                                                </div>
